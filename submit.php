...
.custom-file-label.rounded-pill::after {
  border-radius: 0 50rem 50rem 0;
        ...
        <!-- Cover -->
        <div class="bg-cover" style="background-image: url(assets/img/car2.png);"></div>
                            ...
                            <section class="section" id="contact">
                                <div class="container-fluid">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="row mb-2">
                                              <div class="col-lg-6">
                                                <div class="p-5 bg-white shadow rounded-lg"><img id="imgid1" src="assets/img/car/front-hood.png" alt="" width="200"  class="d-block mx-auto mb-4 rounded-pill">
                                                  ...
                                                  <div class="col-lg-6">
                                                <div class="p-5 bg-white shadow rounded-lg"><img id="imgid2" src="assets/img/car/rear.png" alt="" width="200" class="d-block mx-auto mb-4 rounded-pill">
                                        ...
                                        <div class="row">
                                              <div class="col-lg-6">
                                                <div class="p-5 bg-white shadow rounded-lg"><img id="imgid3" src="assets/img/car/driver-side.png" alt="" width="200"  class="d-block mx-auto mb-4 rounded-pill">
                                                  ...
                                                  <div class="col-lg-6">
                                                <div class="p-5 bg-white shadow rounded-lg"><img id="imgid4" src="assets/img/car/left-side.png" alt="" width="200" class="d-block mx-auto mb-4 rounded-pill">
