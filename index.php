...
.fa{
    ...
    <section class="section section-top section-full">
        ...
        <!-- Cover -->
        <div class="bg-cover" style="background-image: url(assets/img/hero1.jpg);"></div>
    ...
    ================================================== -->
        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-lg-6">
                    <div class="about-img">
                        <img src="assets/img/about/checkingcar.jpg" alt="" class="img-fluid">
                    </div>
                </div>
      ...
      <section class="section bg-light pt-50 pb-30" id="whyus">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <!-- <div class="about-img"> -->
                        <img src="assets/img/about/whyus.png" alt="" class="img-fluid">
                    <!-- </div> -->
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4"> 
                    <div data-aos="zoom-in" data-aos-delay="50" data-aos-duration="2000">
                        <img src="assets/img/frontcar.png" alt="" class="img-fluid animated zoomIn">
                    </div>
                            ...
                            <div class="card mb-2">
                              <div class="card-body">
                                ...
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                                  card's content.</p>
                                 <div class="row">
                                            <div class="col-md-4"><img src="assets/img/testimonies/1.jpg" class="" alt="..." height="100" width="100" style="border-radius: 50%;"></div>
                                            <div class="col-md-8">
                            ...
                            <div class="card mb-2">
                              <div class="card-body">
                                ...
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                                  card's content.</p>
                                 <div class="row">
                                            <div class="col-md-4"><img src="assets/img/testimonies/2.jpg" class="" alt="..." height="100" width="100" style="border-radius: 50%;"></div>
                                            <div class="col-md-8">
                            ...
                            <div class="card mb-2">
                              <div class="card-body">
                                ...
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                                  card's content.</p>
                                 <div class="row">
                                            <div class="col-md-4"><img src="assets/img/testimonies/3.jpg" class="" alt="..." height="100" width="100" style="border-radius: 50%;"></div>
                                            <div class="col-md-8">
